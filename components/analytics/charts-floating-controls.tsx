...
import { ChevronDown, Crown, Calendar, Brain, Users, MessageSquare, Check, ChevronLeft, ChevronRight } from 'lucide-react';
...
interface ChartsFloatingControlsProps {
...
export function ChartsFloatingControls({ 
  currentTimeframe, 
  onTimeframeChange, 
  selectedModels = [],
  onModelsChange = () => {},
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50">
      <div className="flex items-center space-x-4 px-8 py-4 rounded-full backdrop-blur-md bg-[rgba(var(--charcoal),0.85)] border border-[rgba(var(--neon-orchid),0.3)] shadow-2xl">
        {/* Time Filter Toggle - Wider Buttons */}
        <div className="flex items-center space-x-2 relative">
          ...
          {timeViews.map((view) => (
            <button
              ...
              className={cn(
                'px-5 py-2.5 rounded-md text-sm font-medium transition-all duration-200 whitespace-nowrap min-w-[80px]',
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center space-x-2 px-5 py-2.5 rounded-md text-[rgb(var(--foreground))] hover:bg-[rgba(var(--velvet-gray),0.5)] transition-all duration-200 whitespace-nowrap min-w-[140px] border border-[rgba(var(--neon-orchid),0.2)]"
          >
            <Crown className="w-4 h-4 text-[rgb(var(--sunset-gold))]" />
            <span className="text-sm font-medium">{getModelsDisplayText()}</span>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center space-x-2 px-5 py-2.5 rounded-md text-[rgb(var(--foreground))] hover:bg-[rgba(var(--velvet-gray),0.5)] transition-all duration-200 whitespace-nowrap min-w-[140px] border border-[rgba(var(--neon-orchid),0.2)]"
          >
            <Users className="w-4 h-4 text-[rgb(var(--neon-orchid))]" />
            <span className="text-sm font-medium">{getOperatorsDisplayText()}</span>
            <ChevronDown className={cn(
              "w-4 h-4 transition-transform duration-200",
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center space-x-2 px-5 py-2.5 rounded-md text-[rgb(var(--foreground))] hover:bg-[rgba(var(--velvet-gray),0.5)] transition-all duration-200 whitespace-nowrap min-w-[140px] border border-[rgba(var(--neon-orchid),0.2)]"
          >
            <MessageSquare className="w-4 h-4 text-[rgb(var(--sunset-gold))]" />
            <span className="text-sm font-medium">{getChannelsDisplayText()}</span>
            <ChevronDown className={cn(
              "w-4 h-4 transition-transform duration-200",
        ...
        {/* Ask Analytics Button - Wider */}
        <button
          onClick={onAskAnalytics}
          className="flex items-center space-x-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-[rgba(var(--neon-orchid),0.2)] to-[rgba(var(--crimson),0.2)] border border-[rgba(var(--neon-orchid),0.3)] text-[rgb(var(--foreground))] hover:scale-105 transition-all duration-300 shadow-lg whitespace-nowrap min-w-[140px] justify-center"
        >
          <Brain className="w-4 h-4" />
          <span className="text-sm font-medium">Ask Analytics</span>
        </button>
      </div>
    </div>
  );
